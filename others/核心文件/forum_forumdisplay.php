...
if($_G['forum']['type'] == 'forum') {
	...
	if(empty($_GET['archiveid'])) {
		$navigation = ' <em> &gt; </em> <a href="forum.php?gid='.$forum_up['fid'].'">'.$forum_up['name'].'</a><em> &gt; </em> <a href="forum.php?mod=forumdisplay&fid='.$_G['forum']['fid'].'">'.$_G['forum']['name'].'</a>';
	} else {
		$navigation = ' <em> &gt; </em> '.'<a href="forum.php?mod=forumdisplay&fid='.$_G['fid'].'">'.$_G['forum']['name'].'</a> <em> &gt; </em> '.$forumarchive[$_GET['archiveid']]['displayname'];
	}
	...
	if(empty($_GET['archiveid'])) {
		...
		$navigation = ' <em> &gt; </em> <a href="forum.php?gid='.$forum_top['fid'].'">'.$forum_top['name'].'</a><em> &gt; </em> <a href="forum.php?mod=forumdisplay&fid='.$forum_up['fid'].'">'.$forum_up['name'].'</a><em> &gt; </em> '.$_G['forum']['name'];
	} else {
		$navigation = ' <em> &gt; </em> <a href="forum.php?mod=forumdisplay&fid='.$_G['forum']['fup'].'">'.$forum_up['name'].'</a> <em> &gt; </em> '.'<a href="forum.php?mod=forumdisplay&fid='.$_G['fid'].'">'.$_G['forum']['name'].'</a> <em> &gt; </em> '.$forumarchive[$_GET['archiveid']]['displayname'];
	}
